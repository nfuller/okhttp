...
public class ResponseCacheAdapter implements OkResponseCache {
  ...
  /**
   * Retrieves the {@link CacheResponse} from the delegate by converting the
  ...
  /**
   * Extracts OkHttp headers from the supplied {@link CacheResponse}. Only read headers are
  ...
  private static Map<String, List<String>> extractJavaHeaders(Request request) {
    ...
    Map<String, List<String>> headerMap = new HashMap<String, List<String>>(headers.size());
    for (String headerName : headers.names()) {
      headerMap.put(headerName, headers.values(headerName));
    }
   ...
   */
  private final static class CacheHttpURLConnection extends HttpURLConnection {
   ...
   */
  private final static class CacheHttpsURLConnection extends HttpsURLConnection {
